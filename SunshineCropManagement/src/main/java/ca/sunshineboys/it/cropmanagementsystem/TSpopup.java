...
CENG 317 - 0NF
 */
public class TSpopup extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tspop_up);
        button = findViewById(R.id.TSB);
    ...
    private class MyTask extends AsyncTask <Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            startActivity(new Intent(TSpopup.this, SunshineMain.class));
        }
